...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "По Бишкеку 1 рабочий дня (можно уточнить желательное время при оформлении заказа). По регионам Кыргызстана - ориентировочно 3–5 рабочих дней (зависит от службы доставки).",
  },
  {
    question: "Можно ли вернуть или обменять товар?",
    answer:
      "В случае выявления производственного брака вы можете оформить возврат или обмен в течение 14 дней с момента получения товара. Возврат и обмен возможны при условии сохранения товарного вида и упаковки. Для заказов за пределами города Бишкек возврат осуществляется после согласования с нашей службой поддержки.Если у вас возникнут вопросы или сложности с заказом — наша команда всегда готова помочь и предложить оптимальное решение.",
  },
  {
