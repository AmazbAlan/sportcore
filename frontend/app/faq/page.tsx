...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Мы тщательно проверяем каждый товар перед отправкой, чтобы быть уверенными в его качестве. Поэтому возврат и обмен, к сожалению, не предусмотрены за пределами города Бишкек. Внутри города Бишкека возможен возврат или обмен при условии сохранения товарного вида и упаковки. Если у вас возникнут вопросы или трудности с заказом — наша команда всегда готова помочь и найти лучшее решение.",
  },
  {
